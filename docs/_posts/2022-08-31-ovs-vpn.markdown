...
<!---OvS example image --->
<img data-action="zoom" src='{{ "../assets/images/_posts/2022-08-31-ovs-vpn/ovs_example_1.png" | relative_url }}' alt='relative'>
<img data-action="zoom" src='{{ "../assets/images/_posts/2022-08-31-ovs-vpn/ovs_example_2.png" | relative_url }}' alt='relative'>
